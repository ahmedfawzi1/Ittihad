        ...
        <section class="banner-inner-area pt-160 pb-80 bg-image"
            ...
            <div class="container">
                <div class="banner-inner__content">
                    ...
                    <h2 class="text-white wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">البوم الصور</h2>
            ...
            <div class="container">
                <div class="section-header__wrp mb-80">
                    <div class="section-header-two">
                        <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">اخر صورنا
                        </h2>
                    </div>
